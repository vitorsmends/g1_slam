...
class RemapAndFixTF(Node):
    def __init__(self):
        ...
        self.get_logger().info("RemapAndFixTF node started (STABLE MODE)")

    def cb_odom(self, msg: Odometry):

        odom = Odometry()

        # ✅ CRÍTICO: NÃO alterar timestamp
        odom.header = msg.header
        odom.header.frame_id = self.odom_frame

        # ✅ FORÇAR consistência do frame
    ...
    def cb_scan(self, msg: LaserScan):
        ...
        # ✅ CRÍTICO: manter timestamp original
        scan.header = msg.header

        # ✅ apenas corrigir frame
